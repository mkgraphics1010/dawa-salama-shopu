...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-vida-burgundy to-vida-burgundy-dark text-white relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold">VIDA DIVINA</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xl font-bold mb-6 text-vida-cream">Viungo vya Haraka</h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a 
                    href={link.href} 
                    className="text-base opacity-90 hover:opacity-100 hover:text-vida-cream transition-all duration-300 relative group"
                  >
                    {link.name}
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-vida-cream transition-all duration-300 group-hover:w-full"></span>
                  </a>
                </li>
              ))}
            </ul>
          ...
          {/* Services */}
          <div>
            <h4 className="text-xl font-bold mb-6 text-vida-cream">Huduma Zetu</h4>
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service} className="text-base opacity-90 flex items-start">
                  <span className="inline-block w-2 h-2 bg-vida-cream rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  {service}
                </li>
              ))}
            </ul>
          ...
          <div>
            <h4 className="text-xl font-bold mb-6 text-vida-cream">Mawasiliano</h4>
            <div className="space-y-4">
              <div className="flex items-center space-x-3 p-3 bg-white/10 rounded-lg">
                <Phone className="h-5 w-5 opacity-80 text-vida-cream" />
                <div>
              ...
              <div className="flex items-center space-x-3 p-3 bg-white/10 rounded-lg">
                <Mail className="h-5 w-5 opacity-80 text-vida-cream" />
                <div>
                  <p className="text-sm font-semibold">Barua Pepe</p>
                  <p className="text-sm">info@vidadivina.co.tz</p>
                </div>
              </div>
              
              <div className="flex items-start space-x-3 p-3 bg-white/10 rounded-lg">
                <MapPin className="h-5 w-5 opacity-80 mt-1 text-vida-cream" />
                <div>
        ...
        <div className="border-t border-white/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-base opacity-80 mb-4 md:mb-0 text-center md:text-left">
              © {currentYear} Vida Divina. Haki zote zimehifadhiwa. Duka la Dawa la Hali ya Juu.
            </p>
